...
import com.example.tuanlvk57.music.Service.MediaAppWidgetProvider;
import com.example.tuanlvk57.music.Service.MediaButtonIntentReceiver;
import com.example.tuanlvk57.music.SharedPreferences.SharedPreferencesCompat;
...
/**
 * Created by tuanlv.k57 on 02/02/2015.
 */
public class MusicService extends Service{
    ...
    public static final String PLAYSTATE_CHANGED = "com.example.tuanlvk57.music.playstatechanged";
    public static final String META_CHANGED = "com.example.tuanlvk57.music.metachanged";
    public static final String QUEUE_CHANGED = "com.example.tuanlvk57.music.queuechanged";

    public static final String SERVICECMD = "com.example.tuanlvk57.music.musicservicecommand";
    ...
    public static final String TOGGLEPAUSE_ACTION = "ccom.example.tuanlvk57.music.musicservicecommand.togglepause";
    public static final String PAUSE_ACTION = "com.example.tuanlvk57.music.musicservicecommand.pause";
    public static final String PREVIOUS_ACTION = "com.example.tuanlvk57.music.musicservicecommand.previous";
    public static final String NEXT_ACTION = "com.example.tuanlvk57.music.musicservicecommand.next";
    public static final String SHUFFLE_ACTION = "com.example.tuanlvk57.music.musicservicecommand.shuffle";
    public static final String REPEAT_ACTION = "com.example.tuanlvk57.music.musicservicecommand.repeat";
    ...
    private final static int IDLE_DELAY = 60000;
    ...
    private String[] mCursorCols = new String[] {
            "audio._id AS _id",             // index must match IDCOLIDX
    ...
    private Handler mMediaplayerHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            Utils.debugLog("mMediaplayerHandler.handleMessage " + msg.what);
            switch (msg.what) {
                case FADEDOWN:
                    mCurrentVolume -= .05f;
    ...
    private BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Utils.debugLog("mIntentReceiver.onReceive " + action + " / " + cmd);
            ...
            mUnmountReceiver = new BroadcastReceiver() {
                ...
                public void onReceive(Context context, Intent intent) {
                    ...
                    if (action.equals(Intent.ACTION_MEDIA_EJECT)) {
                        ...
                        mMediaMountedCount++;
                        mCardId = Utils.getCardId(MusicService.this);
                        reloadQueue();
    ...
    public void onCreate() {
        ...
        ComponentName cpn = new ComponentName(getPackageName(), MediaButtonIntentReceiver.class.getName());
        mAudioManager.registerMediaButtonEventReceiver(cpn);
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent != null) {
            String action = intent.getAction();
            String cmd = intent.getStringExtra("command");
            Utils.debugLog("onStartCommand " + action + " / " + cmd);
    ...
    public void shuffle(){
        synchronized (this){
            switch (this.getShuffleMode()){
                case SHUFFLE_NONE:
                    this.setShuffleMode(SHUFFLE_NORMAL);
                    break;
                case SHUFFLE_NORMAL:
                    this.setShuffleMode(SHUFFLE_NONE);
                    break;
                case SHUFFLE_AUTO:
                    this.setShuffleMode(SHUFFLE_NONE);
                    break;
    ...
    public void repeat(){
        synchronized (this){
            switch (this.getRepeatMode()){
                case REPEAT_NONE:
                    this.setRepeatMode(REPEAT_CURRENT);
                    break;
                case REPEAT_CURRENT:
                    this.setRepeatMode(REPEAT_ALL);
                    break;
                case REPEAT_ALL:
                    this.setRepeatMode(REPEAT_NONE);
                    break;
                default:
                    this.setRepeatMode(REPEAT_NONE);
                    break;
    ...
    private void notifyChange(String what) {
        ...
        if (what.equals(PLAYSTATE_CHANGED)) {
            ...
            Bitmap b = Utils.getArtwork(this, getAudioId(), getAlbumId(), false);
            if (b != null) {
    ...
    private void updateNotification() {
        ...
        views.setImageViewResource(R.id.ivNotification, R.drawable.linh_user);
        if (getAudioId() < 0) {
            // streaming
            views.setTextViewText(R.id.tvNameNotification, getPath());
            views.setTextViewText(R.id.tvArtistNotification, null);
        } else {
            String artist = getArtistName();
            views.setTextViewText(R.id.tvNameNotification, getTrackName());
            ...
            views.setTextViewText(R.id.tvArtistNotification, getArtistName());
        }
        Notification status = new Notification();
        status.contentView = views;
        status.flags |= Notification.FLAG_ONGOING_EVENT;
        status.icon = R.drawable.linh_user;
    ...
    private class MultiPlayer {
        ...
        public MultiPlayer() {
            mCurrentMediaPlayer.setWakeMode(MusicService.this, PowerManager.PARTIAL_WAKE_LOCK);
        }
        ...
        public void start() {
            Utils.debugLog(new Exception("MultiPlayer.start called"));
